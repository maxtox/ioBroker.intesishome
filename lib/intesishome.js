...
const INTESIS_MAP = {
    ...
    43: {
        _id: 'WATER_TANK_MODE_EXEC',
        common: {
            type: 'boolean',
            name: 'WATER_TANK_MODE_EXEC',
            role: 'switch',
            read: true,
            write: false
        },
    ...
    55: {
        _id: 'HEATING_DEVIATION_TEMPERATURE',
        common: {
            type: 'number',
            name: 'HEATING_DEVIATION_TEMPERATURE',
            unit: '°C',
            role: 'level.temperature',
            read: true,
            write: true
    ...
    57: {
        _id: 'WATER_TANK_MAX_TEMPERATURE',
        common: {
            type: 'number',
            name: 'WATER_TANK_MAX_TEMPERATURE',
            unit: '°C',
            role: 'level.temperature',
            read: true,
            write: true
    ...
    90: {
        _id: 'HEATING_MAX_TEMPERATURE',
        common: {
            type: 'number',
            name: 'HEATING_MAX_TEMPERATURE',
            unit: '°C',
            role: 'level.temperature',
            read: true,
            write: true
    ...
    93: {
        _id: 'HEATING_MODE_EXEC',
        common: {
            type: 'boolean',
            name: 'HEATING_MODE_EXEC',
            role: 'switch',
            read: true,
            write: false
        },
    ...
    142: {
        ...
        native: {
            states: {0: 'HEAT_PUMP_OFF', 1: 'HEAT_PUMP_ON'},
            uid: 142
        }
    },
    148: {
